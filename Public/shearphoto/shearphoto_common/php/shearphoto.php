...
//判断用户
 ...
 //删除原文件 下同
   unlink($path.'/shearphoto/shearphoto_common/file/shearphoto_file/'.$_SESSION['Wap_user']['user_ava']);
   $_SESSION['Wap_user']['user_ava']=$result[0]['ImgName'];
   $_SESSION['Wap_user']['update']=1;

 }

 if(!empty($_SESSION['Home_user'])){
 unlink($path.'/shearphoto/shearphoto_common/file/shearphoto_file/'.$_SESSION['Home_user']['user_ava']); 
  $_SESSION['Home_user']['user_ava']=$result[0]['ImgName'];
  $_SESSION['Home_user']['update']=1;
}
//$_SESSION['path']=$result[0]['ImgName'];
